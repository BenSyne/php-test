...
<head>
    ...
    <title>Login - Direct Meds Pharmacy</title>
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-6 space-y-2 text-sm text-gray-600">
                        <div class="bg-gray-50 p-3 rounded">
                            ...
                            <p>Email: admin@directmeds.com</p>
                            <p>Password: password123</p>
                        </div>
                        <div class="bg-gray-50 p-3 rounded">
                            <p class="font-semibold">Pharmacist</p>
                            <p>Email: pharmacist@directmeds.com</p>
                            <p>Password: password123</p>
                        </div>
                        <div class="bg-gray-50 p-3 rounded">
                            <p class="font-semibold">Patient</p>
                            <p>Email: patient@directmeds.com</p>
                            <p>Password: password123</p>
                        </div>
                    </div>
                </div>
